...
#     list_display = ('get_ticket_classes', 'user', 'ticket_code', 'price_paid', 'is_checked_in', 'booked_at')
#     list_filter = ('ticket_classes__event', 'is_checked_in')
#     search_fields = ('ticket_code', 'user__email', 'ticket_classes__name')
#     readonly_fields = ('price_paid', 'booked_at')
#     fieldsets = [
#         (None, {
#             'fields': ('ticket_classes', 'user', 'is_checked_in')
#         })
#     ]
#
#     def get_ticket_classes(self, obj):
#         return ", ".join(tc.name for tc in obj.ticket_classes.all())
#     get_ticket_classes.short_description = 'Hạng vé'
#
#
